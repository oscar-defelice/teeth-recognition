...
The aim of this section is to define a metric to measure the amount of similarity of two images.
Actually, what we want to measure is the degree of confidence of a match between two images.
